...
def build_real_fusion_payload(
    ...
    with _QPU_LOCK:
        ...
        merge_plan = build_merge_plan(
            graph, partitioning, merge_strategy, merge_order, planner_mode
        )
        ...
        return {
            ...
            "active_positive_coupling_count": result[
                "active_positive_coupling_count"
            ],
            "active_positive_coupling_weight": result[
                "active_positive_coupling_weight"
            ],
            "sample_ms": result["sample_ms"],
            "initial_sample_ms": result["initial_sample_ms"],
            "conditioned_sample_ms": result["conditioned_sample_ms"],
            "fusion_ms": result["fusion_ms"],
            "total_runtime_ms": result["total_runtime_ms"],
            "initial_sampling_calls": result["initial_sampling_calls"],
            "conditioned_resampling_calls": result[
                "conditioned_resampling_calls"
            ],
            "sampling_calls": result["sampling_calls"],
            "assignment_size": result["assignment_size"],
            "execution_steps": result["execution_steps"],
            "message": "Tree-guided execution completed on a D-Wave QPU.",
        }
